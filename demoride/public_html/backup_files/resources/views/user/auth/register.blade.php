        ...
        <div class="row no-margin">
            ...
            <div class="col-md-6 log-right">
                ...
                <div class="login-box row no-margin">
                    <div class="col-md-12">
                        <a class="log-blk-btn" href="{{url('login')}}">¿
Do you already have an account?</a>
                    ...
                    <form role="form" method="POST" action="{{ url('/register') }}">
                        <div id="first_step">
                            ...
                            <div class="col-md-8">
                                <input type="text" autofocus id="phone_number" class="form-control" placeholder="Enter Phone Number" name="phone_number" value="{{ old('phone_number') }}" data-stripe="number" maxlength="11" onkeypress="return isNumberKey(event);" />
                            </div>
                    ...
                    <div class="col-md-12">
                        <p class="helper">Or <a href="{{route('login')}}">login</a> with your user account.</p>
                    </div>
                </div>
