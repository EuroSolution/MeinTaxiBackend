        ...
        <div class="row no-margin">
            ...
            <div class="col-md-6 log-right">
                ...
                <div class="login-box row no-margin">
                    <div class="col-md-12">
                        <a class="log-blk-btn" href="{{url('login')}}">¿Do you already have an account?</a>
<h3>Reset password</h3>                    </div>
                    ...
                    <form role="form" method="POST" action="{{ url('/password/email') }}">
                        ...
                        <div class="col-md-12">
                            <button class="log-teal-btn" type="submit">
SEND PASSWORD RESTORE LINK</button>
                        </div>
                    </form>     

                    <div class="col-md-12">
                        <p class="helper">O <a href="{{route('login')}}">Sign in</a> with your user account.</p>  
                    </div>
