            ...
            <div class="box b-a-0">
                ...
                {{ csrf_field() }}
                    ...
                    <div class="px-2 form-group mb-0">
                        <button type="submit" class="btn btn-purple btn-block text-uppercase">SEND PASSWORD RESTORE LINK</button>
                    </div>
                </form>
                <div class="p-2 text-xs-center text-muted">
                    <a class="text-black" href="{{ url('/account/login') }}"><span class="underline">Enter here!
!</span></a>
                </div>
            </div>
        </div>
