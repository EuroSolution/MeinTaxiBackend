...
class ProviderController extends Controller
{
    ...
    public function earnings()
    {
        ...
        return view('provider.payment.earnings')->with(['provider'=>$provider,'weekly'=>$weekly,'fully'=>$fully,'today'=>$today,'weekly_sum'=>$weekly_sum,'fully_sum'=>$fully_sum]);
    }
    ...
    public function upcoming_trips()
    {
        ...
        return view('provider.payment.upcoming')->with(['fully'=>$fully]);
    }
    ...
    public function wallet_transation(Request $request){
        ...
        try{
            ...
            return view('provider.wallet.wallet_transation')->with(['wallet_transation'=>$wallet_transation,'pagination'=>$pagination,'wallet_balance'=>$wallet_balance]);
    ...
    public function transfer(Request $request){
        ...
        $wallet_balance=Auth::user()->wallet_balance;
        return view('provider.wallet.transfer')->with(['pendinglist'=>$pendinglist,'wallet_balance'=>$wallet_balance]);
    }
    ...
    public function cards()
    {
        ...
        return view('provider.wallet.card')->with(['cards'=>$cards]);
    }
}