...
class UserApiController extends Controller
{
    ...
    public function login(Request $request)
    {
        ...
        $tokenRequest = $request->create(env('APP_URL').'/oauth/token', 'POST', $request->all());
        // return $tokenRequest;
   ...
   //  dd($Providers);
    ...
    public function estimated_fare(Request $request){
        ...
        try{       
            ...
            return response()->json(['error' => $e->getMessage().", ".$e->getFile().", ".$e->getLine()], 500);
        }
    }
    ...
    public function forgot_password(Request $request){
        ...
        //try{  
            ...
            $number = $user->mobile;
            $mesaage = "HelloRide User, Your reset password OTP is ".$otp;
            $mask = null;

            
            Helper::sendOtp($number,$mesaage,null,$mask);
            return response()->json([
    ...
    public function sendOtp(Request $request) {
        $message = "Sms Testing Zong";
        $number = 923170370270;
        $result =  Helper::sendOtp($number,$message);
        return response()->json(['OTP' => date('Y-m-d H:i:s'),'result'=>$result]);
    }
