...
class Helper
{
    ...
    public static function sendOtp($number,$message, $otp = null,$mask = null) {

        $number = str_replace("+","",$number);
        $aPayload =
        [
                "loginId"=> "923190026757",
        ...
        $ch = curl_init("https://cbs.zong.com.pk/reachrestapi/home/SendQuickSMS");
