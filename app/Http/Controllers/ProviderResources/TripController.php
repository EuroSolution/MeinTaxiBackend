...
{    
    ...
    public function index(Request $request)
    {
        try{
            ...
            $aacountStatus = $Provider->status;
            $serviceStatus = $Provider->service ? Auth::user()->service->status : 'offline';
            $lowBalance = false;
    ...
    public function update(Request $request, $id)
    {
        ...
        try{
            ...
            if($request->status == 'DROPPED' && $UserRequest->payment_mode != 'CASH') {
                ...
                $RequestPayment->kv_photo = $request->kv_photo;
    ...
    */ 
    ...
    public function requestamount(Request $request){
        ...
        try{
            ...
            $amountRequest->request_from= str_replace('"',"",$request->type);
            $amountRequest->from_id=Auth::user()->id;
            $amountRequest->type='C';
            ...
            if ($request->hasFile('attachment')) {
                $amountRequest->attachment = $request->attachment->store('attachment');
            }
