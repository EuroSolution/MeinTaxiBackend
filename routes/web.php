...
Route::get('/clear_cache', function() {
    // $ab = shell_exec('composer install:passport');
    // $ab = Artisan::call('passport:client --password');
        // $ab = Artisan::call('passport:client');
        $ab = Artisan::call('cache:clear');
...
Route::get('/email_test' , 	'MailController@basic_email');
