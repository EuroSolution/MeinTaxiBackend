...
<head>
    ...
    <title>{{ Setting::get('site_title','Hello Ride') }}</title>
    ...
    <div id="wrapper">
                        ...
                        <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                            <ul class="nav navbar-nav">
                                <li @if(Request::url() == url('/ride')) class="active" @endif>
                                    <a href="{{url('/ride')}}">@lang('user.users')</a>
                                </li>
                                <li @if(Request::url() == url('/drive')) class="active" @endif>
                                    <a href="{{url('/drives')}}">@lang('user.user_drivers')</a>
                                </li>
                                 <li><a href="{{ url('help') }}">@lang('user.user_contact_us')</a></li>
                                  
                            </ul>
                            <ul class="nav navbar-nav navbar-right">
                               
                                <li><a class="btn-outline" href="{{url('/register')}}">Login as User</a></li>
                                <li><a class="menu-btn" href="{{url('/provider/register')}}">Login as Driver</a></li>
                            </ul>
                        </div>
                    </div>
                </nav>
        ...
        <div class="row">
            ...
            <div class="col-xs-12 col-sm-12 col-md-2 col-md-offset-1 support">
                 ...
                 <div class="col-xs-12 col-sm-12  col-md-6 sup-txt"><h2>¿need help?<br>Contact our support area</h2>
                     <div class="call-num">
<h3 class=""><a href="tel:{{ Setting::get('contact_number', '+9297911 01817
')  }}"><!-- <span class="phone-icon"><i class="fa fa-3x fa-phone"></i></span> --> {{ Setting::get('contact_number', '+9297911 01817
')  }}</a> </h3>
                </div>
             </div>
            ...
            <!--  <div class="col-md-12">
                <div class="call-num">
<h3 class=""><a href="tel:{{ Setting::get('contact_number', '')  }}"><span class="phone-icon"><i class="fa fa-3x fa-phone"></i></span> {{ Setting::get('contact_number', '+9297911 01817
')  }}</a> </h3>
                </div>
    ...
    <div class="container pad-60"">
        <div class="row center">
            ...
            <p class="white">(Get the Android and iOS apps for riders and drivers for free)</p><br>
            <div class="">
    ...
    <div class="container footer-social content-block pad-60"">
        <div class="row center">
            <h2>D-91, Block-6 PECHS Karachi</h2>
  ...
  <div class="modal-dialog">
    ...
    <div class="modal-content">
      ...
      <div class="modal-body">
        <p>{{ Setting::get('site_title','HelloRIde') }} is available in your city</p>
      </div>
