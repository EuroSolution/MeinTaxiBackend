                         ...
                         <div class="row no-margin">
                                <div class="col-lg-12 col-md-12 col-sm-8 col-xs-12 no-padding">
                                    <div class="prof-form-sub-sec">
                                        <div class="row no-margin">
                                            <form class="profile-form" enctype="multipart/form-data" action="{{route('provider.requestamount')}}" method="POST"  role="form" id="requestform">
                                            {{ csrf_field() }}
                                            ...
                                            <div class="prof-sub-col col-sm-4 col-xs-12 no-left-padding">
                                                <div class="form-group">
                                                    ...
                                                    <input type="file" class="form-control" placeholder="attachment" name="attachment" value="" required="">
                                                </div>
                                            </div>
