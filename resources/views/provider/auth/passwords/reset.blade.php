...
@section('content')
<div class="col-md-12">
    <a class="log-blk-btn" href="{{ url('/provider/register') }}">Do you already have an account?</a>    
...
<div class="col-md-12">
    ...
    <p class="helper">Or <a href="{{url('provider/login')}}">Sign in</a> with your user account.</p>   
