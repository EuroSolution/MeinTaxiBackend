...
$ACCESS_PWD='ppk@dev'; #!!!IMPORTANT!!! this is script access password, SET IT if you want to protect you DB from public access

#DEFAULT db connection settings
# --- WARNING! --- if you set defaults - it's recommended to set $ACCESS_PWD to protect your db!
$DBDEF=array(
'user'=>"u327760836_work",#required
'pwd'=>"India@123", #required
'db'=>"u327760836_work",  #optional, default DB
'host'=>"",#optional
'port'=>"",#optional
